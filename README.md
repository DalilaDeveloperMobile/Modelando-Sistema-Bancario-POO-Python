...
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Desafio - Parte 1:
```
...
class Deposito(Transacao):
    ...
    def registrar(self, conta):
        ...
        if sucesso_transacao:
            conta.historico.adicionar_transacao(self)
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Desafio - Parte 2:
```
import textwrap
from abc import ABC, abstractclassmethod, abstractproperty
from datetime import datetime
